...
import by.runets.vehiclescrapper.scrapper.copart.executor.impl.lookup.TransmissionTypeScrapperExecutor
...
class TransmissionTypeScrapService(@Autowired
                                   ...
                                   @Autowired
                                   private var transmissionTypeScrapper: TransmissionTypeScrapperExecutor) : AbstractScrapService<Set<TransmissionType>>() {
